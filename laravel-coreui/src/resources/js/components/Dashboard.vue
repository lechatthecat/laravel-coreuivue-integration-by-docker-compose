    ...
    <b-row>
      <b-col sm="6" lg="3">
        <b-card no-body class="bg-primary">
          ...
          <card-line1-chart-example chartId="card-chart-01" class="chart-wrapper px-3" style="height:70px;width: 100% !important;" :height="70"/>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
        <b-card no-body class="bg-info">
          ...
          <card-line2-chart-example chartId="card-chart-02" class="chart-wrapper px-3" style="height:70px;width: 100% !important;" :height="70"/>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: 'images/coreui/avatars/1.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'images/coreui/avatars/2.jpg', status: 'danger' },
        ...
        {
          avatar: { url: 'images/coreui/avatars/3.jpg', status: 'warning' },
        ...
        {
          avatar: { url: 'images/coreui/avatars/4.jpg', status: '' },
        ...
        {
          avatar: { url: 'images/coreui/avatars/5.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'images/coreui/avatars/6.jpg', status: 'danger' },
